                ...
                <div class="collapse navbar-collapse"
                    ...
                    <ul class="nav navbar-nav">
                        <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#">More Links </a>
                            <div class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="/cs4116/group06/discover.php">Discover</a><a class="dropdown-item" role="presentation" href="/cs4116/group06/accountInfo.php">Account Info</a><a class="dropdown-item" role="presentation" href="/cs4116/group06/messaging.html">Messages</a></div>
                        </li>
                    </ul>
