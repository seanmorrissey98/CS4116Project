                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">2000</p><a class="card-link" href="#">Link</a><a class="card-link" href="#"></a></div>
                    </div>
                </div>
                <div class="col">
                    <div class="card">
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6 class="text-muted card-subtitle mb-2"></h6>
                            <p class="card-text">47</p><a class="card-link" href="#">Link</a><a class="card-link" href="#"></a></div>
                    </div>
                </div>
            </div>
        </div>
